...
namespace Nop.Services.Messages
{
    ...
    public partial interface IWorkflowMessageService
    {
        ...
        /// The task result contains the queued email identifier
        /// </returns>
        Task<IList<int>> SendNewCustomerNoteAddedCustomerNotificationAsync(CustomerNote customerNote, int languageId);
        ...
        /// The task result contains the queued email identifier
        /// </returns>
        Task<IList<int>> SendNewCustomerNoteAddedStoreOwnerNotificationAsync(CustomerNote customerNote, int languageId);
