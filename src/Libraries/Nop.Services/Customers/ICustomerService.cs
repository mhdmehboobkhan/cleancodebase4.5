...
namespace Nop.Services.Customers
{
    ...
    public partial interface ICustomerService
    {
        ...
        /// </returns>
        Task<CustomerNote> GetCustomerNoteByIdAsync(int customerNoteId);
        ...
        /// The task result contains the result
        /// </returns>
        Task<IPagedList<CustomerNote>> GetAllCustomerNotesAsync(int customerId = 0, bool? displayToCustomer = null,
        ...
        /// <returns>A task that represents the asynchronous operation</returns>
        Task DeleteCustomerNoteAsync(CustomerNote customerNote);
        ...
        string FormatCustomerNoteText(CustomerNote customerNote);
        ...
        /// <param name="customerNote">The order note</param>
        /// <returns>A task that represents the asynchronous operation</returns>
        Task InsertCustomerNoteAsync(CustomerNote customerNote);
