...
namespace Nop.Web.Infrastructure
{
    ...
    public partial class RouteProvider : BaseRouteProvider, IRouteProvider
    {
        ...
        public void RegisterRoutes(IEndpointRouteBuilder endpointRouteBuilder)
        {
            ...
            endpointRouteBuilder.MapControllerRoute(name: "CustomerNotes",
                pattern: $"{lang}/customer/notes",
                defaults: new { controller = "Customer", action = "Notes" });
            ...
            endpointRouteBuilder.MapControllerRoute(name: "GetCustomerNoteFile",
                pattern: $"download/customernotefile/{{customernoteid:min(0)}}",
                defaults: new { controller = "Download", action = "GetCustomerNoteFile" });
