...
namespace Nop.Web.Areas.Admin.Controllers
{
    public partial class CustomerController : BaseAdminController
    {
        ...
        public virtual async Task<IActionResult> CustomerNotes()
        {
            if (!await _permissionService.AuthorizeAsync(StandardPermissionProvider.ManageCustomers))
                return AccessDeniedView();
        ...
        [HttpPost]
        public virtual async Task<IActionResult> CustomerNotesSelect(CustomerNoteSearchModel searchModel)
        {
            if (!await _permissionService.AuthorizeAsync(StandardPermissionProvider.ManageCustomers))
                return await AccessDeniedDataTablesJson();
        ...
        public virtual async Task<IActionResult> CustomerNoteAdd(int customerId, int downloadId, bool displayToCustomer, string message)
        {
            if (!await _permissionService.AuthorizeAsync(StandardPermissionProvider.ManageCustomers))
                return AccessDeniedView();
            ...
            {
                //email
                await _workflowMessageService.SendNewCustomerNoteAddedCustomerNotificationAsync(customerNote, (await _workContext.GetWorkingLanguageAsync()).Id);
            }
        ...
        [HttpPost]
        public virtual async Task<IActionResult> CustomerNoteDelete(int id)
        {
            if (!await _permissionService.AuthorizeAsync(StandardPermissionProvider.ManageCustomers))
                return AccessDeniedView();
