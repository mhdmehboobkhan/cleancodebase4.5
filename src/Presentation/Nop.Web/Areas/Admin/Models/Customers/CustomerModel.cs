...
namespace Nop.Web.Areas.Admin.Models.Customers
{
    ...
    public partial record CustomerModel : BaseNopEntityModel, IAclSupportedModel
    {
        ...
        public CustomerModel()
        {
            ...
            AddCustomerNoteModel = new CustomerNoteModel();
            CustomerNoteSearchModel = new CustomerNoteSearchModel();
        ...
        public CustomerNoteModel AddCustomerNoteModel { get; set; }

        public CustomerNoteSearchModel CustomerNoteSearchModel { get; set; }
