...
namespace Nop.Web.Factories
{
    ...
    public partial class CustomerModelFactory : ICustomerModelFactory
    {
        ...
        public virtual async Task<CustomerNavigationModel> PrepareCustomerNavigationModelAsync(int selectedTabId = 0)
        {
            ...
            model.CustomerNavigationItems.Add(new CustomerNavigationItemModel
            {
                RouteName = "CustomerNotes",
                Title = await _localizationService.GetResourceAsync("Account.CustomerNotes"),
                Tab = CustomerNavigationEnum.Notes,
                ItemClass = "fa-light fa-sticky-note"
            });
            ...
            model.CustomerNavigationItems.Add(new CustomerNavigationItemModel
            {
                ...
                ItemClass = "fa-light fa-map-marker"
            });
        ...
        /// </returns>
        public virtual async Task<CustomerAddressSearchModel> PrepareCustomerAddressSearchModelAsync(CustomerAddressSearchModel searchModel)
        {
            if (searchModel == null)
        ...
        /// </returns>
        public virtual async Task<CustomerAddressListModel> PrepareCustomerAddressListModelAsync(CustomerAddressSearchModel searchModel)
        {
            var addresses = (await _customerService.GetAddressesByCustomerIdAsync((await _workContext.GetCurrentCustomerAsync()).Id))
                ...
                .OrderByDescending(address => address.CreatedOnUtc).ThenByDescending(address => address.Id).ToListAsync().Result
        ...
        public virtual async Task<CustomerNoteListModel> PrepareCustomerNoteListModelAsync(CustomerNoteSearchModel searchModel)
        {
            ...
            //get notes
            var customerNotes = await _customerService.GetAllCustomerNotesAsync(customerId: (await _workContext.GetCurrentCustomerAsync()).Id,
                displayToCustomer: true, dateFrom: createdOnFromValue, dateTo: createdToFromValue, 
