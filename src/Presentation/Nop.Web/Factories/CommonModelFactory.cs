...
namespace Nop.Web.Factories
{
    ...
    public partial class CommonModelFactory : ICommonModelFactory
    {
        ...
        public virtual async Task<CommonStatisticsModel> PrepareCommonStatisticsModel()
        {
            ...
            //get notes
            var customerNotes = await _customerService.GetAllCustomerNotesAsync(customerId: customer.Id,
                displayToCustomer: true, getOnlyTotalCount: true);

            var model = new CommonStatisticsModel
            {
                NumberOfNotes = customerNotes.TotalCount
            };
