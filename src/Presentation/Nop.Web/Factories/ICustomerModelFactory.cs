...
namespace Nop.Web.Factories
{
    ...
    public partial interface ICustomerModelFactory
    {
        ...
        /// </returns>
        Task<CustomerAddressSearchModel> PrepareCustomerAddressSearchModelAsync(CustomerAddressSearchModel searchModel);
        ...
        /// </returns>
        Task<CustomerAddressListModel> PrepareCustomerAddressListModelAsync(CustomerAddressSearchModel searchModel);
